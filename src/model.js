...
export const TYPE_META = {
  [NOURISHING]: {
    label:          "Nourishing",
    dotClass:       "bg-moss",
    btnClass:       "border border-moss/20 bg-moss/5 hover:bg-moss/10 text-ash hover:text-moss",
    pillClass:      "bg-moss/10 text-moss",
    countTextClass: "text-moss",
    cardBg:         "rgba(136,214,167,0.03)",
    cardBorderClass:"border-moss/10 hover:border-moss/20",
  },
  [LIMITING]: {
    label:          "Limiting",
    dotClass:       "bg-ember",
    btnClass:       "border border-ember/20 bg-ember/5 hover:bg-ember/10 text-ash hover:text-ember",
    pillClass:      "bg-ember/10 text-ember",
    countTextClass: "text-ember",
    cardBg:         "rgba(255,159,128,0.03)",
    cardBorderClass:"border-ember/10 hover:border-ember/20",
  },
  [NEUTRAL]: {
    label:          "Neutral",
    dotClass:       "bg-clay",
    btnClass:       "border border-clay/20 bg-clay/5 hover:bg-clay/10 text-ash hover:text-clay",
    pillClass:      "bg-clay/10 text-clay",
    countTextClass: "text-clay",
    cardBg:         "rgba(163,177,194,0.03)",
    cardBorderClass:"border-clay/10 hover:border-clay/20",
  },
};
