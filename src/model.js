...
export const TYPE_META = {
  [NOURISHING]: {
    label:          "Nourishing",
    dotClass:       "bg-moss",
    btnClass:       "border border-moss/35 bg-moss/12 text-moss hover:bg-moss/20",
    pillClass:      "bg-moss/14 text-moss",
    countTextClass: "text-moss",
    cardBg:         "rgba(136,214,167,0.03)",
    cardBorderClass:"border-moss/20 hover:border-moss/30",
  },
  [LIMITING]: {
    label:          "Limiting",
    dotClass:       "bg-ember",
    btnClass:       "border border-ember/35 bg-ember/12 text-ember hover:bg-ember/20",
    pillClass:      "bg-ember/14 text-ember",
    countTextClass: "text-ember",
    cardBg:         "rgba(255,159,128,0.03)",
    cardBorderClass:"border-ember/20 hover:border-ember/30",
  },
  [NEUTRAL]: {
    label:          "Neutral",
    dotClass:       "bg-clay",
    btnClass:       "border border-clay/35 bg-clay/12 text-clay hover:bg-clay/20",
    pillClass:      "bg-clay/14 text-clay",
    countTextClass: "text-clay",
    cardBg:         "rgba(163,177,194,0.03)",
    cardBorderClass:"border-clay/20 hover:border-clay/30",
  },
};
